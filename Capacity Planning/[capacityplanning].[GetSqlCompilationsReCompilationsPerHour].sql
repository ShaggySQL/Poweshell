...
/****** Object:  StoredProcedure [capacityplanning].[GetSqlCompilationsReCompilationsPerHour]    Script Date: 11/12/2019 10:46:54 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE   procedure [capacityplanning].[GetSqlCompilationsReCompilationsPerHour]
...
FROM #TEmpSQLServerStats TSSS
	...
	TSSS.DayAndHour = TUP.DayAndHour
WHERE TUP.Tile <> 20
GROUP BY TSSS.DayAndHour
	,TSSS.InstanceName
	,AVG_UserProcesses
	,MAX_UserProcesses
	,AVG_SqlCompilations
...
FROM #Temp95UserProcesses T95UP
	...
	T95UP.DayAndHour = TSC.DayAndHour
WHERE TSC.Tile <> 20
GROUP BY T95UP.DayAndHour
	,T95UP.InstanceName
	,AVG_UserProcesses
	,MAX_UserProcesses
	,AVG_SqlCompilations
...
FROM #Temp95SqlCompilations T95SC
	...
	T95SC.DayAndHour = TSRC.DayAndHour
WHERE TSRC.Tile <> 20
GROUP BY T95SC.DayAndHour
	,T95SC.InstanceName
	,AVG_UserProcesses
	,MAX_UserProcesses
	,AVG_SqlCompilations
