...
/****** Object:  StoredProcedure [capacityplanning].[GetDiskLatencyPerHour]    Script Date: 11/12/2019 10:31:14 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE   procedure [capacityplanning].[GetDiskLatencyPerHour]
...
FROM #TempDiskLatency TDL
	...
	TDL.DayAndHour = TADQL.DayAndHour
WHERE TADQL.Tile <> 20
GROUP BY TDL.DayAndHour
	,TDL.InstanceName
	,AVG_AverageDiskQueueLength
	,MAX_AverageDiskQueueLength
	,AVG_AverageDiskMillisecondsPerRead
...
FROM  #Temp95AverageDiskQueueLength T95ADQL
	...
	T95ADQL.DayAndHour = TADMPR.DayAndHour
WHERE TADMPR.Tile <> 20
GROUP BY T95ADQL.DayAndHour
	,T95ADQL.InstanceName
	,AVG_AverageDiskQueueLength
	,MAX_AverageDiskQueueLength
	,AVG_AverageDiskMillisecondsPerRead
...
FROM  #Temp95AverageDiskMillisecondsPerRead T95DMPR
	...
	T95DMPR.DayAndHour = TADMPW.DayAndHour
WHERE TADMPW.Tile <> 20
GROUP BY T95DMPR.DayAndHour
	,T95DMPR.InstanceName
	,AVG_AverageDiskQueueLength
	,MAX_AverageDiskQueueLength
	,AVG_AverageDiskMillisecondsPerRead
